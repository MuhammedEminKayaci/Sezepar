            ...
            <ul className="space-y-2">
              {brands.map((b) => (
                <li key={b.slug}>
                  <Link
                    href={`/${b.slug}`}
                    className="text-sm text-[#a3a3a3] hover:text-amber-500 transition-colors"
                  >
                    {b.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 text-amber-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href={`tel:${SITE_CONFIG.phone}`} className="text-sm text-[#a3a3a3] hover:text-amber-500 transition-colors">
                  {SITE_CONFIG.phone}
                </a>
              </li>
              <li className="flex items-start gap-2">
                ...
                <a href={`mailto:${SITE_CONFIG.email}`} className="text-sm text-[#a3a3a3] hover:text-amber-500 transition-colors">
                  {SITE_CONFIG.email}
                </a>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm text-[#a3a3a3]">{SITE_CONFIG.address}</span>
              </li>
            </ul>
          </div>
        </div>
